...
//    if (item) {
//        
//        NSLog(@"[DefaultNSOutlineViewDataSource] numberOfChildrenOfItem() mid level items requested!");
//        
//        if ([item isKindOfClass:[NSDictionary class]]) {
...
//        // https://stackoverflow.com/questions/6664898/nsoutlineview-example/9387255#9387255
//        // item is nil when the outline view wants to inquire for root level items
//        NSLog(@"[DefaultNSOutlineViewDataSource] numberOfChildrenOfItem() root level items requested! amount: %i", number);
//        
//        
//        return number;
//    }
